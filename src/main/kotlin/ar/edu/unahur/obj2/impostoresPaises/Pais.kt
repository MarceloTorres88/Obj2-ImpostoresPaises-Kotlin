...
class Lenguages (val name : String)
...
object Argentina : Pais{
    ...
    override val languages = listOf<Lenguages>(Lenguages("Spanish"), Lenguages("Guaraní"))
    override val regionalBlocs =  listOf<regionalBlocs>(regionalBlocs("USAN","Union of South American Nations"))
}
...
object Brasil : Pais{
    ...
    override val languages = listOf<Lenguages>(Lenguages("Portuguese"))
    override val regionalBlocs =  listOf<regionalBlocs>(regionalBlocs("USAN","Union of South American Nations"))
}
...
object Peru : Pais{
    ...
    override val languages = listOf<Lenguages>(Lenguages("Spanish"))
    override val regionalBlocs =  listOf<regionalBlocs>(regionalBlocs("PA","Pacific Alliance"),regionalBlocs("USAN","Union of South American Nations"))
}
...
object Bolivia : Pais{
    ...
    override val languages = listOf<Lenguages>(Lenguages("Spanish"), Lenguages("Aymara"), Lenguages("Quechua"))
    override val regionalBlocs =  listOf<regionalBlocs>(regionalBlocs("USAN","Union of South American Nations"))
}
...
object España : Pais{
    ...
    override val languages = listOf<Lenguages>(Lenguages("Spanish"))
    override val regionalBlocs =  listOf<regionalBlocs>(regionalBlocs("EU","European Union"))
}
...
object Panama : Pais{
    ...
    override val languages = listOf<Lenguages>(Lenguages("Spanish"))
    override val regionalBlocs =  listOf<regionalBlocs>(regionalBlocs("CAIS","Central American Integration System"))
}
...
object China : Pais{
    ...
    override val languages = listOf<Lenguages>(Lenguages("Chinese"))
    override val regionalBlocs =  listOf<regionalBlocs>(regionalBlocs("EU","European Union"))
}
